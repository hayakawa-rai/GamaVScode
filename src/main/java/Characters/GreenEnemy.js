...
export class GreenEnemy extends Enemy {
  ...
  constructor(mapData) {
    ...
    let imagePath = "../../resources/picture/nari_EnemyGreen.png";

    if (this.mapData) {
      switch (this.mapData.getStageNumber()) {
        case 1:
          // ステージ1
          imagePath = "../../resources/picture/nari_EnemyGreen.png";
          break;

        case 2:
          // ステージ2
          imagePath = "../../resources/picture/taku_EnemyGreen.png";
          break;

        case 3:
          // ステージ3
          imagePath = "../../resources/picture/aniki_EnemyGreen.png";
          break;
  ...
  decideNextDirection(validDirections, map, mapData) {
    ...
    const distance = Math.sqrt(
      Math.pow(myCol - targetCol, 2) + Math.pow(myRow - targetRow, 2),
    );
