...
export class Syujinkou extends Character {
  ...
  move(map) {
    ...
    if (this.direction !== Direction.NONE) {
      ...
      const dx =
        typeof this.direction.getDX === "function"
          ? this.direction.getDX()
          : this.direction.dx;
      const dy =
        typeof this.direction.getDY === "function"
  ...
  isAligned() {
    return (
      this.x % Syujinkou.CELL_SIZE === 0 && this.y % Syujinkou.CELL_SIZE === 0
    );
  }
